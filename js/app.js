...
const imgConreiner = document.querySelector('.js-gallery')
const imgMarkup = makeGalleryItemsMarkup(galleryItems) 
imgConreiner.insertAdjacentHTML('beforeend',imgMarkup)
...
imgConreiner.addEventListener('click', onModalOpen)
